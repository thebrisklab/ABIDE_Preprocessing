...
for (sub in subnames) {
  funcname=list.files(paste0("ABIDEI-NYU/",sub,"/func/"))
  path_name=paste0("ABIDEI-NYU/",sub,"/func/",funcname)
  ...
  png(filename = paste0("check_4_volumes/ABIDEI-NYU/",sub,"_Mean_series_plot.png"),width = 800, height = 350)

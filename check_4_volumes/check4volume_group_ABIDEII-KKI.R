...
for (sub in subnames) {
  funcname=list.files(paste0("ABIDEII-KKI/",sub,"/ses-1/func/"))
  path_name=paste0("ABIDEII-KKI/",sub,"/ses-1/func/",funcname)
  ...
  png(filename = paste0("check_4_volumes/ABIDEII-KKI/",sub,"_Mean_series_plot.png"),width = 800, height = 350)

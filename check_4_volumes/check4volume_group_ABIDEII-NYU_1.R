...
for (sub in subnames) {
  funcname=list.files(paste0("ABIDEII-NYU_1/",sub,"/ses-1/func/"))
  path_name=paste0("ABIDEII-NYU_1/",sub,"/ses-1/func/",funcname)
  ...
  png(filename = paste0("check_4_volumes/ABIDEII-NYU_1/",sub,"_Mean_series_plot.png"),width = 800, height = 350)

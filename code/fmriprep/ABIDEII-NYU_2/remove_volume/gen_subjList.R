...
for(sub in subnames){
  # filename
  nii_name = list.files(paste0("ABIDEII-NYU_2/",sub,"/ses-1/func/"))
...
# write the txt tile
setwd("/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/ABIDEII-NYU_2/script/remove_volume")

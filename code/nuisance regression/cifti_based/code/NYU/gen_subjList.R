...
# write the txt tile
setwd("/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/script/cifti_based/code/NYU")
...
# write the txt tile
setwd("/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/script/cifti_based/code/NYU")
write.table(my_list, file = "subjList_ABIDEII_1.txt",
            row.names = FALSE, col.names = FALSE,quote = FALSE)
...
# write the txt tile
setwd("/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/script/cifti_based/code/NYU")
write.table(my_list, file = "subjList_ABIDEII_2.txt",
            row.names = FALSE, col.names = FALSE,quote = FALSE)

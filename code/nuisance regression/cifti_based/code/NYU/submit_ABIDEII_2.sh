...
# chmod u+x submit_ABIDEII_2.sh
# ./submit_ABIDEII_2.sh

# scratch file
myscratch=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/scratch/cifti_based/cifti_ABIDEII-NYU_2
...
while read p; do
	...
	#echo $subj
	#echo $niifile
	qsub -o $myscratch/out/$subj.out -e $myscratch/err/$subj.err Subj_36p_ABIDEII_2.sh $subj $niifile
done < subjList_ABIDEII_2.txt

...
# write the txt tile
setwd("/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/script/cifti_based/cifti_to_nifti/NYU")
...
# write the txt tile
setwd("/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/script/cifti_based/cifti_to_nifti/NYU")
write.table(my_list, file = "subjList_ABIDEII_1_cifti.txt",
            row.names = FALSE, col.names = FALSE,quote = FALSE)
...
# write the txt tile
setwd("/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/script/cifti_based/cifti_to_nifti/NYU")
write.table(my_list, file = "subjList_ABIDEII_2_cifti.txt",
            row.names = FALSE, col.names = FALSE,quote = FALSE)

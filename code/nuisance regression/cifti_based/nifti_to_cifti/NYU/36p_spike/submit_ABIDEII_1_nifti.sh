...
# chmod u+x submit_ABIDEII_1_nifti.sh
# ./submit_ABIDEII_1_nifti.sh

# scratch file
myscratch=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/scratch/cifti_based/ABIDEII-NYU_1_nifti_to_cifti
...
while read p; do
	...
	qsub -o $myscratch/out/$subj.out -e $myscratch/err/$subj.err trans_ABIDEII_1.sh $subj $niifile_nifti $niifile_cifti_temp
done < subjList_ABIDEII_1_nifti.txt

...
# chmod u+x submit_ABIDEI_nifti.sh
# ./submit_ABIDEI_nifti.sh

# scratch file
myscratch=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/scratch/cifti_based/ABIDEI-NYU_nifti_to_cifti
...
while read p; do
	...
	qsub -o $myscratch/out/$subj.out -e $myscratch/err/$subj.err trans_ABIDEI.sh $subj $niifile_nifti $niifile_cifti_temp
done < subjList_ABIDEI_nifti.txt

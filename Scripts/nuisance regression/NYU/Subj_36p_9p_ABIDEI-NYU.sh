...
func_dir=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/ABIDEI-NYU/derivatives
nuisance_dir=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/ABIDEI-NYU/${subj}/nuisance
out_dir=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/ABIDEI-NYU/${subj}/volume_based

echo "Performing nuisance regression: volume 36p + (NO temporal filtering), remove the first time point"
## No spatial smoothing:
$afnidir/3dTproject -input ${func_dir}/${subj}/func/${niifile} \

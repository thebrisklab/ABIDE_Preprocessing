...
nuisance_dir=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/ABIDEII-NYU_2/${subj}/nuisance
out_dir=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/ABIDEII-NYU_2/${subj}/volume_based
...
echo "Performing nuisance regression: volume 36p + (NO temporal filtering)_ + 6 mm fwhm spatial smoothing, remove the first time point"
## Spatial smoothing:
$afnidir/3dTproject -input ${func_dir}/${subj}/ses-1/func/${niifile} \
...
echo "Performing nuisance regression: volume 9p + (NO temporal filtering)_ + 6 mm fwhm spatial smoothing, remove the first time point"
## Spatial smoothing:
$afnidir/3dTproject -input ${func_dir}/${subj}/ses-1/func/${niifile} \

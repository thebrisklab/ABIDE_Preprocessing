...
# scratch file
myscratch=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/scratch/volume/ABIDEII-NYU_1
...
while read p; do
	...
	#echo $subj
	#echo $niifile
	qsub -o $myscratch/out/$subj.out -e $myscratch/err/$subj.err Subj_36p_9p_ABIDEII-NYU_1.sh $subj $niifile

...
# chmod u+x submit_ABIDEII.sh
# ./submit_ABIDEII.sh

# scratch file
myscratch=/data/home4/risk_share/ImproveFConnASD/ABIDE/fmriprep_preprocessed/36p/scratch/volume/ABIDEII-KKI
...
while read p; do
	...
	#echo $subj
	#echo $niifile
	qsub -o $myscratch/out/$subj.out -e $myscratch/err/$subj.err Subj_36p_9p_ABIDEII.sh $subj $niifile
done < subjList_ABIDEII.txt
